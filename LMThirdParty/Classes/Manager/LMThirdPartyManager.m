...
@interface LMThirdPartyManager ()<JPUSHRegisterDelegate>
@end
...
-(void)setupThirdPartyConfigurationWithApplication:(UIApplication *)application didFinishedLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    entity.types=JPAuthorizationOptionBadge | JPAuthorizationOptionAlert | JPAuthorizationOptionSound;
    [JPUSHService registerForRemoteNotificationConfig:entity delegate:self];
    [JPUSHService setupWithOption:launchOptions
                           appKey:@"bea04211a3f61fbe0abcd1bc"
                          channel:@"APPStore"
                 apsForProduction:NO];
}
